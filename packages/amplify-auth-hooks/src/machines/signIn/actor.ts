...
export const signInActor = (handlers: SignInHandlers, overridesContext?: SignInContext) => {
  return setup({
    ...
    actions: {
      ...
      setChallengeName: assign({ challengeName: setChallengeName }),
          ...
          submit: {
            ...
            invoke: {
              ...
              onDone: [
                ...
                { actions: ['setChallengeName', 'setNextSignInStep', 'setTotpSecretCode', 'setAllowedMfaTypes'], target: '#signInActor.init' },
              ],
